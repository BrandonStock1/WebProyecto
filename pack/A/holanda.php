...
<body style="background-image: url('../../assets/img/negro.png');">
  ...
  <div>
      ...
      <a class="carousel-control-prev" href="senegal.php" role="button" data-bs-slide="prev">
        <span class="carousel-control-prev-icon bi bi-chevron-left" aria-hidden="true"></span>
      </a>

      <a class="carousel-control-next" href="../B/grupo-B.html" role="button" data-bs-slide="next">
      ...
      <section id="alb" class="alb">
        ...
        ?>
            ...
            <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
              ...
              <li><a href="holanda.php" class="filter-active">Holanda</a></li>
            </ul>
