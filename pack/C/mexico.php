...
<body style="background-image: url('../../assets/img/negro.png');">
  ...
  <div>
      ...
      <a class="carousel-control-prev" href="../../pack/C/arabia.php" role="button" data-bs-slide="prev">
        <span class="carousel-control-prev-icon bi bi-chevron-left" aria-hidden="true"></span>
      </a>

      <a class="carousel-control-next" href="../../pack/C/polonia.php" role="button" data-bs-slide="next">
      ...
      <section id="alb" class="alb">
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>PORTERO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 113";
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 114";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 115";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 116";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 117";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 118";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 119";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 120";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 121";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DELANTERA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 122";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DELANTERA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 123";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
        ...
        ?>
            ...
            <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
              ...
              <li><a href="../../pack/C/mexico.php"class="filter-active">México</a></li>
