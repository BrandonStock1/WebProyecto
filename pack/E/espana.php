...
<body style="background-image: url('../../assets/img/negro.png');">
  ...
  <div>
      ...
      <a class="carousel-control-prev" href="../../pack/E/grupo-E.html" role="button" data-bs-slide="prev">
        <span class="carousel-control-prev-icon bi bi-chevron-left" aria-hidden="true"></span>
      </a>

      <a class="carousel-control-next" href="../../pack/E/costa.php" role="button" data-bs-slide="next">
      ...
      <section id="alb" class="alb">
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>PORTERO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 179";
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 180";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 181";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 182";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 183";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 184";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 185";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 186";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 187";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DELANTERA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 188";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DELANTERA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 189";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
        ...
        ?>
            ...
            <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
              <li><a href="../../pack/E/espana.php"class="filter-active">España</a></li>
