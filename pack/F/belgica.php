...
<body style="background-image: url('../../assets/img/negro.png');">
  ...
  <div>
      ...
      <a class="carousel-control-prev" href="../../pack/F/grupo-F.html" role="button" data-bs-slide="prev">
        <span class="carousel-control-prev-icon bi bi-chevron-left" aria-hidden="true"></span>
      </a>

      <a class="carousel-control-next" href="../../pack/F/canada.php" role="button" data-bs-slide="next">
      ...
      <section id="alb" class="alb">
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>PORTERO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 223";
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 224";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 225";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 226";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 227";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 228";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 229";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 230";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 231";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DELANTERA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 232";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DELANTERA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 233";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
        ...
        ?>
            ...
            <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
              <li><a href="../../pack/F/belgica.php"class="filter-active">Bélgica</a></li>
