...
<body style="background-image: url('../../assets/img/negro.png');">
  ...
  <div>
      ...
      <a class="carousel-control-prev" href="../../pack/F/marruecos.php" role="button" data-bs-slide="prev">
        <span class="carousel-control-prev-icon bi bi-chevron-left" aria-hidden="true"></span>
      </a>

      <a class="carousel-control-next" href="../../pack/G/grupo-G.html" role="button" data-bs-slide="next">
      ...
      <section id="alb" class="alb">
        <div class="container" data-aos="fade-up">
          ...
          <div class="portfolio-isotope" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
            ...
            <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
              ...
              <li><a href="../../pack/F/grupo-F.html"class="filter-active">Grupo F</a></li>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>PORTERO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 256";
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 257";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 258";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 259";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 260";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 261";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 262";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 263";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 264";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DELANTERA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 265";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DELANTERA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 266";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
        ...
        ?>
            ...
            <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
              <li><a href="../../pack/F/belgica.php">Bélgica</a></li>
              <li><a href="../../pack/F/canada.php">Canada</a></li>
              <li><a href="../../pack/F/marruecos.php" >Marruecos</a></li>
              <li><a href="../../pack/F/croacia.php"class="filter-active">Croacia</a></li>
            </ul>
