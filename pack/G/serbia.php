...
<body style="background-image: url('../../assets/img/negro.png');">
  ...
  <div>
      ...
      <a class="carousel-control-prev" href="../../pack/G/brasil.php.php" role="button" data-bs-slide="prev">
        <span class="carousel-control-prev-icon bi bi-chevron-left" aria-hidden="true"></span>
      </a>

      <a class="carousel-control-next" href="../../pack/G/suiza.php.php" role="button" data-bs-slide="next">
      ...
      <section id="alb" class="alb">
        <div class="container" data-aos="fade-up">
          ...
          <div class="portfolio-isotope" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
            ...
            <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
              ...
              <li><a href="../../pack/G/grupo-G.html"class="filter-active">Grupo G</a></li>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>PORTERO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 278";
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 279";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 280";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 281";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 282";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DEFENSA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 283";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 284";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 285";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>MEDIOCAMPO</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 286";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DELANTERA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 287";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
              ...
              <div class="col-lg-2 col-md-4 portfolio-item">
                <div class="portfolio-content">
                  ...
                  <div class="portfolio-info">
                    <h4>DELANTERA</h4>
                    <?php 
                    $query = "SELECT * FROM jugadores WHERE id = 288";
                    $result = DB::getInstance()->query($query);
                    if($result->count() != 0){
                      foreach($result->results() as $fila){
                echo '<p>
        ...
        ?>
            ...
            <ul class="portfolio-flters" data-aos="fade-up" data-aos-delay="100">
              <li><a href="../../pack/G/brasil.php">Brasil</a></li>
              <li><a href="../../pack/G/serbia.php"class="filter-active">Serbia</a></li>
              <li><a href="../../pack/G/suiza.php" >Suiza</a></li>
              <li><a href="../../pack/G/camerun.php">Camerún</a></li>
            </ul>
