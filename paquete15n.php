      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <h2 data-aos="fade-down">Compra el sobre de <br><span>15 Figuritas random</span></h2>
            <p data-aos="fade-up">Ten en cuenta que obtendras 15 figuritas random, pero se te restara el gasto del precio del sobre (400 coins)</p>
