      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <h2 data-aos="fade-down">Compra el sobre de <br><span>5 Figuritas (Objetos)</span></h2>
            <p data-aos="fade-up">Ten en cuenta que obtendras 5 figuritas de objetos, pero se te restara el gasto del precio del sobre (350 coins)</p>
